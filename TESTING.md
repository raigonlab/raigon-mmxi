...
| ---------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------ | ----------------------------------------------- |
| Home (gallery)    | ![mobile](documentation/responsiveness/mobile-home.png)             | ![tablet](documentation/responsiveness/tablet-home.png)             | ![desktop](documentation/responsiveness/desktop-home.png)              | Parallax gallery and depth-of-field scale correctly |
| Artwork Modal     | ![mobile](documentation/responsiveness/mobile-modal.png)            | ![tablet](documentation/responsiveness/tablet-modal.png)            | ![desktop](documentation/responsiveness/desktop-modal.png)             | Info/inquire panels align with artwork on tablet |
| Vault             | ![mobile](documentation/responsiveness/mobile-vault.png)            | ![tablet](documentation/responsiveness/tablet-vault.png)            | ![desktop](documentation/responsiveness/desktop-vault.png)             | Collection cards stack/center correctly        |
| Accord access gate | ![mobile](documentation/responsiveness/mobile-access-gate.png)      | ![tablet](documentation/responsiveness/tablet-access-gate.png)      | ![desktop](documentation/responsiveness/desktop-access-gate.png)       | Input no longer triggers iOS zoom              |
